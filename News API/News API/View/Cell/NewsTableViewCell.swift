...
final class NewsTableViewCell: UITableViewCell {
  ...
  private let imageTitle: UIImageView = {
    ...
    image.image = UIImage(systemName: Constant.photo)
    return image
  }()
  ...
  private let labelDescription: UILabel = {
    ...
    labelDescription.font = UIFont(name: Constant.avenirNextFont , size: 18)
  ...
  func configureCell(with model: News) {
    if model.urlToImage != nil {
      ...
      imageTitle.image = UIImage(systemName: Constant.photo) 
    }
